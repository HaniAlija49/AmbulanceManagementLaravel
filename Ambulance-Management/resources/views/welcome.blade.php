...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      ...
      <div class="d-flex align-items-center">
        <i class="bi bi-phone"></i> Call us now +389 71 548 831
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{ route('appointments.create') }}" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointment</a>
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <a class="cta-btn scrollto" href="{{ route('appointments.create') }}">Make an Make an Appointment</a>
        </div>
...
@endif
    ...
    <section id="contact" class="contact">
      ...
      <div>
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5930.0985530903345!2d21.435078!3d41.999218!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x135415b1c05feab5%3A0x7fceaf0cd9aea62f!2sSEE%20University!5e0!3m2!1sen!2sus!4v1705927995565!5m2!1sen!2sus" width=" 100%" height="350px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Call Us</h3>
                  <p>+389 71 548 831<br>+389 70 553 525</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                SEE University <br>
                Skopje<br><br>
                <strong>Phone:</strong> +389 71 548 831<br>
